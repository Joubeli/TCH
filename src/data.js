...
export const Products = [
  {
    ...
    conciseDesc: `• Grand écran numérique
                  ...
                  • Émetteur Bluetooth® 4.0 intégré (HID)
                  • Distance de transmission jusqu'à 15 m
                  • Alimenté par une pile CR2032 standard`,
    fullDesc: ` • Grand écran numérique
                • Version mm ou pouce disponible
                • Émetteur Bluetooth® 4.0 intégré (HID)
                • Distance de transmission jusqu'à 15 m
                • Alimenté par une pile CR2032 standard
    ...
    conciseDesc: `Unité d'affichage moderne et compacte,
                  ...
                  Grand écran tactile 4,3'' avec fonctions intuitives,
                  Construction antichoc`,
    fullDesc: ` Unité d'affichage moderne et compacte,
                2 entrées de sonde numérique P12D (M8) - aucun appairage requis,
                Grand écran tactile 4,3'' avec fonctions intuitives,
                Construction antichoc,
                Formules de base (modèle Standard) et mesures dynamiques (modèle Avancée),
                Autonomie de la batterie intégrée 8 heures (modèle Avancée),
                Indication de la tolérance globale (modèle Avancée),
                Tolérances et classes de tolérance (modèle Avancée),
    ...
    conciseDesc: `Fonctions intuitives, 
                  Grande mobilité, 
                  Mesure de diamètres internes et externes, axes, hauteurs, épaisseurs, profondeurs, surfaces, 
                  Gamme 150, 300 et 450 mm, 
                  Sortie de données USB et RS232 et Bluetooth®`,
    fullDesc: ` Fonctions intuitives
                Grande mobilité, 
                Mesure de diamètres internes et externes, axes, hauteurs, épaisseurs, profondeurs, surfaces, 
                Gamme 150, 300 et 450 mm, 
                Sortie de données USB et RS232 et Bluetooth®, 
                Force de mesure extrêmement faible et réglable en fonction de la sonde, 
                Aucune influence de l'opérateur sur les résultats de mesure, 
    ...
    fullDesc: ` Ecran tactile 4’’3, 
                Compatible avec les jauges de prise et d'air, 
                Disponible en 2 versions : 1 ou 2 entrées, 
                Entrée pour MB-IO, 
                Affichage simple ou double avec bargraphe, aiguille ou sans tolérances, 
                Mesure directe ou Min, Max, Moyenne, Max-Min..., 
                Interface conviviale, 
                Construction très robuste (Aluminium), 
                Connexion USB «Clavier» unidirectionnel et RS232 bidirectionnel, 
    ...
    Le sans couture permet un meilleur confort et évite les irritations,Embouts en PVC pour...`,
    fullDesc: `Nylon (polyamide) Une fibre synthétique qui offre une haute résistance à l'abrasion, 
    Ne se déforme pas et sèche rapidement, 
