    ...
    <section className="sec-part" id="partenaires">
      ...
      <div className="Partner-Slider-container" data-aos="fade-up">
        <Slider {...settings} className="slick-slider">
          <div style={{ width: 520 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://www.hellermanntyton.com/">
              <img style={{ paddingTop: "7%" }} src={part1} alt="logo" />
            </a>
          </div>
          <div style={{ width: 430 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://www.tesa.com/fr-fr">
          ...
          <div style={{ width: 280 }}>
            <a
              ...
              href="https://www.kimberly-clark.com/de-de/germany"
            >
              <img style={{ paddingTop: "20%" }} src={part3} alt="logo" />
            </a>
          </div>
          <div style={{ width: 300 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://www.sylvac.ch/">
              <img style={{ paddingTop: "11%" }} src={part4} alt="logo" />
            </a>
          </div>
          <div style={{ width: 220 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://www.kstools.fr/">
              <img style={{ paddingTop: "15%" }} src={part5} alt="logo" />
            </a>
          </div>
          <div style={{ width: 350 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://www.wezag.de/">
              <img src={part6} alt="logo" />
            </a>
          </div>
          <div style={{ width: 400 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://www.lakesprecision.com/">
              <img
          ...
          <div style={{ width: 380 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://www.carl-valentin.de/startseite/">
              <img
                style={{ paddingTop: "9%", marginRight: "10%" }}
                src={part8}
                alt="logo"
              />
            </a>
          ...
          <div style={{ width: 450 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://mibostahl.com/fr/">
              <img style={{ paddingTop: "7%" }} src={part9} alt="logo" />
            </a>
          </div>
          <div style={{ width: 250 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://www.lista.com/fr/">
              <img style={{ paddingTop: "25%" }} src={part10} alt="logo" />
            </a>
          </div>
          <div style={{ width: 180 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://www.bimos.com/B/fr-fr/index.php">
              <img style={{ paddingTop: "32%" }} src={part11} alt="logo" />
            </a>
          </div>
          <div style={{ width: 460 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://tomasbodero.com/es/">
              <img style={{ paddingTop: "8%" }} src={part12} alt="logo" />
            </a>
          </div>
          <div style={{ width: 340 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://metzner.com/index.php/de/">
              <img
                width="300px"
                style={{ paddingTop: "20%" }}
                src={part13}
          ...
          <div style={{ width: 380 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://www.ramatech.ch/index.php/de/">
              <img
                width="350px"
                style={{ paddingTop: "7%" }}
                src={part14}
          ...
          <div style={{ width: 250 }}>
            <a target="_blank" rel="noopener noreferrer" href="https://www.artosengineering.com/">
              <img
                width="200px"
                style={{ paddingTop: "11%" }}
                src={part16}
