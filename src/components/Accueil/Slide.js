...
import accueil1 from '../../images/Accueil/111.jpg'
import accueil2 from '../../images/Accueil/222.jpg'
import accueil3 from '../../images/Accueil/333.jpg'
...
const Slide = () => {
  ...
  return (
    ...
    <Carousel fade>
      <Carousel.Item>
        <h1 className="message-accueil message-1">Un process de câblage automobile et aéronautique est le coeur de notre activité.</h1>
        <img
